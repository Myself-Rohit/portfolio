...
function Home() {
    return (
        <>
            <div id="home" className='flex flex-col sm:flex-row justify-center min-h-screen items-center bg-no-repeat bg-center bg-cover bg-[url("https://media.istockphoto.com/photos/product-showcase-with-spotlight-black-studio-room-background-use-as-picture-id1304681590?b=1&k=20&m=1304681590&s=170667a&w=0&h=UlTsdL4KIRPcxbhgOrsIoE0BNNE6KpgxVhRD3gz_fV0=")]' >
                <div className="shrink-0">
                    <img src={photoHome} className="w-72 h-72 rounded-full object-fit object-left border-2 border-cyan-600" />
                </div>
