...
function Contact() {
  ...
  return (
    ...
    >
      <h1 className="title-contact text-white text-4xl font-bold text-center">
      ...
      <div className="flex flex-col p-4 sm:flex-row flex-wrap sm:gap-10 shrink-0 sm:items-start items-center justify-center text-white mx-auto mt-10 ">
        <div className="flex flex-col gap-y-5">
          <div className="inp-left flex flex-col items-start">
            <label>Name:</label>
        ...
        <div className="input-contact bg-gradient-to-r from-slate-600 to-cyan-600 rounded mt-10 sm:mt-0 max-w-96">
